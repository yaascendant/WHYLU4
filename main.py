...
PHRASES = [
  ...
  "Когда Меки рассплитается на второй сайд?",
    "Когда новый сезон?",
    "Когда добавят карту?",
    "Когда БлекШедоу перестанет давать бэкстабы в лицо?",
    "Когда вырежут спойл?",
    "Когда сделают спойлера сильным?",
    "Когда колы перестанут дорожать?",
    "Когда колы перестанут дешеветь?",
    "Когда Жопе начнут возить нормальную пиццу?",
    "Когда суп будет горячим?",
    "Когда апнут ЕЕ?",
    "Когда понерфят ШЕ?",
    "Когда апнут Варка?",
]
